...
export const Login = () => {
  ...
  return (
    <>
      ...
      <Layout style={{ minHeight: "100vh", background: "#E6EDFD" }}>
        <Header className='pageHeader' style={{ background: '#346DF2', padding: '10px 5px 8px 5px' }}>
          <Row justify='center' gutter={10}>
            <Col xs={9} sm={10} md={7} lg={7} xl={19}>
              <img src={logo} alt="example" className='recLogo' />
            </Col>
            <Col xs={7} sm={9} md={7} lg={7} xl={2}>
              {/* <div className='registerHeader'>რეგისტრაცია</div> */}
            </Col>
            <Col xs={7} sm={3} md={7} lg={7} xl={2}>
              {/* <div className='avtHeader'>შესვლა</div> */}
            </Col>
          </Row>
        </Header>
        <br />
                ...
                <Col span={24} style={{ width: 300 }}>
                  <Card style={{ border: '1px solid #FFFF', borderRadius: '20px', backgroundColor: '#FFFF', width: '100%', margin: 'auto' }}>
                    <div style={{ margin: 'auto' }}>
                      <div className='card1'>
                        <div className='cardTitle'> ჯანდაცვის სერვისები3
                      ...
                      <div className='card4'>
                        <div className='cardTitle'> ჯანდაცვის სერვისები <Button

                          onClick={prev4} >prev</Button> <img src={ArrowLeft} onClick={() => { ref4.current?.next() }} alt="" /></div>
                        <Button
