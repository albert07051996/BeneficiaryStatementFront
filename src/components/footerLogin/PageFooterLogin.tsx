  ...
  return (
    <>
      <Footer className="LoginpageFooterNew">
        ...
        <br />
        <div className="ufleba">
          ყველა უფლება დაცულია © 2023 საქართველოს შრომის, ჯანმრთელობისა და სოციალური
          დაცვის სამინისტრო
        </div>
      </Footer>
    </>
